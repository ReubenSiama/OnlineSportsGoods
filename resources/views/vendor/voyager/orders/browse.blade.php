                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endforeach
                                            @switch($order_status = $data->status)
                                                @case("Order Placed")
                                                    <a href="{{ route('changeStatus',['status'=>'Confirmed','id'=>$data->id]) }}" class="btn btn-success">Confirm</a>
                                                    @break
                                                @case("Confirmed")
                                                    <a href="{{ route('changeStatus',['status'=>'Dispatched','id'=>$data->id]) }}" class="btn btn-success">Dispatch</a>
                                                    @break
                                                @case("Dispatched")
                                                    <a href="{{ route('changeStatus',['status'=>'Arriving Today','id'=>$data->id]) }}" class="btn btn-success">Arriving Today</a>
                                                    @break
                                                @case("Arriving Today")
                                                    <a href="{{ route('changeStatus',['status'=>'Delivered','id'=>$data->id]) }}" class="btn btn-success">Deliver</a>
                                                    @break
                                            @endswitch
                                            <a href="{{ route('viewOrder',['id'=>$data->id]) }}" class="btn btn-info">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
